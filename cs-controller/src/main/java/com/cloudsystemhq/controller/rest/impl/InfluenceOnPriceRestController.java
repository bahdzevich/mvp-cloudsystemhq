...
public class InfluenceOnPriceRestController extends
    AbstractCrudRestController<InfluenceOnPriceRequestDto, InfluenceOnPriceResponseDto, Long,
  ...
  public ResponseEntity<InfluenceOnPriceResponseDto> create(@PathVariable Long answerId,
      @Valid @RequestBody InfluenceOnPriceRequestDto influenceOnInvoice) {
  ...
  public ResponseEntity<InfluenceOnPriceResponseDto> update(
      ...
      @Valid @RequestBody InfluenceOnPriceRequestDto influenceOnPriceRequestDto) {
